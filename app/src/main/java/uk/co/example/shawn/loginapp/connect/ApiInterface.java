...
import uk.co.example.shawn.loginapp.model.event.Search;
import uk.co.example.shawn.loginapp.model.venue.Venue;

/**
 * Created by Shawn Li on 27/10/2016.
 */
...
public interface ApiInterface {
    ...
    Observable<uk.co.example.shawn.loginapp.model.venue.Search> queryVenue(@Query("app_key") String appKey, @Query("keywords") String query,
    ...
    Observable<uk.co.example.shawn.loginapp.model.artist.Search> queryArtist(@Query("app_key") String appKey, @Query("keywords") String query,
    ...
    Observable<uk.co.example.shawn.loginapp.model.artist.Search> queryArtist(@Query("apikey") String apiKey, @Query("query") String query);

    @GET("search/venues.json")
    Observable<uk.co.example.shawn.loginapp.model.venue.Search> queryVenue(@Query("apikey") String apiKey, @Query("query") String query);

    @GET("search/locations.json")
    Observable<uk.co.example.shawn.loginapp.model.location.Search> queryLocationByText(@Query("apikey") String apiKey, @Query("query") String query);

    @GET("search/locations.json")
    Observable<uk.co.example.shawn.loginapp.model.location.Search> queryLocationByGeo(@Query("apikey") String apiKey, @Query("location") String latLngStr);
    ...
    Observable<uk.co.example.shawn.loginapp.model.venue.Search> getVenueDetails(@Query("apikey") String apiKey, @Path("venue_id") int venueId);

    @GET("artists/{artist_id}/similar_artists.json")
    Observable<uk.co.example.shawn.loginapp.model.artist.Search> similarArtists(@Query("apikey") String apiKey, @Path("artist_id") int artistId);*/
}
