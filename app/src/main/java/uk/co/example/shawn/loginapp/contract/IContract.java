...
import uk.co.example.shawn.loginapp.Analytics;
import uk.co.example.shawn.loginapp.DetailedEntryFragment;
import uk.co.example.shawn.loginapp.LoginActivity;
import uk.co.example.shawn.loginapp.PresenterParams.Columns;
import uk.co.example.shawn.loginapp.connect.ApiClient;
import uk.co.example.shawn.loginapp.connect.ApiInterface;
